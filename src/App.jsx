...
const questions = [
  ...
  
  {
    ...
    answers: ["А:  Марс", "Юпітер", "C:  Венера", "D:  Сатурн"],
    correct: 1,
...

  {
    ...
    answers: ["Тихий", "B:  Атлантичний", "C:  Індійський", "D:  Український"],
    correct: 3,
  ...
  return (
    <div className="App">
        <div className={style.wrapper}>
          <Header/>
          {step != questions.length ? <Game step = {step} question = {question} setVariant = {setVariant} length = {questions.length}/> : <Result/>}   
        </div>
    </div>
  );
}
